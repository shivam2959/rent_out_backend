...
SPECTACULAR_SETTINGS = {
    'TITLE': 'RentEase API',
    'DESCRIPTION': 'API for RentEase property management platform',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@rentease.com')
...
# ---------------------------------------------------------------------------
# SECURITY (active only in production, i.e. when DEBUG is False)
# ---------------------------------------------------------------------------
if not DEBUG:
