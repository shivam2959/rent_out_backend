    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner'), ('tenant', 'Tenant'), ('lease_operator', 'Lease Operator'), ('admin', 'Admin')], default='tenant', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified', models.BooleanField(default=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lease_operator_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
