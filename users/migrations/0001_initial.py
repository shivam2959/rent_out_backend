    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner'), ('tenant', 'Tenant'), ('operator', 'Lease Operator'), ('admin', 'Admin')], default='tenant', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_proof_document', models.FileField(blank=True, null=True, upload_to='id_documents/')),
                ('is_verified', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pan_document', models.FileField(blank=True, null=True, upload_to='kyc_documents/')),
                ('aadhar_document', models.FileField(blank=True, null=True, upload_to='kyc_documents/')),
