    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Owner'), ('tenant', 'Tenant'), ('operator', 'Lease Operator')], default='tenant', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operating_area', models.CharField(blank=True, max_length=200, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
